...
class Trainer extends CoreModel
{
    ...
    protected $fillable     = ['id', 'profile_id', 'academic_level_id', 'name', 'surname', 'surname2', 'gender_id', 'birth_date', 'email', 'phone', 'mobile', 'tin', 'availabilities', 'has_authorization', 'country_id', 'territorial_area_1_id', 'territorial_area_2_id', 'territorial_area_3_id', 'zip', 'locality', 'address', 'latitude', 'longitude', 'specialty', 'is_register_jccm', 'categories', 'teacher_training', 'teacher_training', 'teaching_months', 'occupation_months', 'description'];
    public $with            = ['profile'];
    protected $casts        = [
