...
class ActionService
{
    ...
    private static function checkCreate($object)
    {
        ...
        if(empty($object['online']))        throw new \Exception('You have to define a online field to create a action');
        if(empty($object['subsidized']))    throw new \Exception('You have to define a subsidized field to create a action');
    }
