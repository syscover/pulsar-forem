...
return [
    ...
    //******************************************************************************************************************
    'modalities' => [
        (object)['id' => 1, 'name' => 'Modalidad I',    'code' => 'FPTO'],
        (object)['id' => 2, 'name' => 'Modalidad II',   'code' => 'FPTD'],
        (object)['id' => 3, 'name' => 'Modalidad III',  'code' => 'FPCI'],
        (object)['id' => 4, 'name' => 'Modalidad IV',   'code' => 'FPDR'],
        (object)['id' => 5, 'name' => 'Modalidad V',    'code' => 'FPFP'],
        (object)['id' => 6, 'name' => 'Modalidad VI',   'code' => 'FPPE'],
    ],
